...
|--------|----------|---------------|
| FusionCore | 4.195 | 14.682 |
| RL-EKF | 10.777 | 36.660 |
...
ros2 launch fusioncore_datasets nclt_benchmark.launch.py \
  data_dir:=/path/to/nclt/2012-03-31 output_bag:=./nclt_results
...
# 5. Evaluate
python3 tools/evaluate.py --gt gt.tum --fusioncore fc.tum --rl rl.tum --sequence 2012-03-31
```
