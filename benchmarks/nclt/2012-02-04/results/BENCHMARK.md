...
|--------|----------|---------------|
| FusionCore | 15.057 | 67.378 |
| RL-EKF | 20.543 | 51.620 |
...
ros2 launch fusioncore_datasets nclt_benchmark.launch.py \
  data_dir:=/path/to/nclt/2012-02-04 output_bag:=./nclt_results
...
# 5. Evaluate
python3 tools/evaluate.py --gt gt.tum --fusioncore fc.tum --rl rl.tum --sequence 2012-02-04
```
