...
- Five tests pinning the gate behaviour, including the exact case from issue #73 (a 2 m / 8 m fix must be accepted) and a regression guard that the DOP path still applies when no covariance is present. Test count is now 119.
